          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <button @click="exportToPDF" class="float-end">
                    Export to PDF
                  </button>
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-sm-4 text-center">
                      ...
                      <img
                        ...
                        width="150"
                      />
                      <h5>(<span class="fw-bold">{{ note.signatures[0].supir }}</span>)</h5>
                    </div>
                    ...
                    <div class="col-sm-4 text-center">
                      ...
                      />
                      <h5>
                        (<span class="fw-bold">{{ note.signatures[0].petugas }}</span>)
                      </h5>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="row mt-5 ">
                      ...
                      <small>Dokument ini dicetak pada: {{ now.date }} {{ now.time }}</small>
                    <!-- <div class="col-sm-6">
                    </div> -->
                    <!-- <div class="col-sm-6"></div> -->
                  </div>
